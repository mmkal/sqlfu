...
test('generate writes query exports and source hashes into the generated query manifest', async () => {
  ...
  expect(generatedManifest).toContain(`sourceHash: "${sha256(querySql)}"`);
