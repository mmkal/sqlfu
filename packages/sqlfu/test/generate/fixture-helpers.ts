 ...
 */
async function typecheckGeneratedFiles(root: string): Promise<readonly string[]> {
...
function parseOutputGlobs(raw: string | undefined): readonly string[] | undefined {
...
export function updateFixtureOutputs(
  ...
  input: {outputGlobs?: readonly string[]} = {},
): void {
...
function rewriteTestOutputs(
  ...
  testName: string,
  outputs: Record<string, string>,
  outputGlobs: readonly string[] | undefined,
): string {
